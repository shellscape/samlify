            ...
            selection.forEach(function (signatureNode) {
                ...
                if (opts.keyFile) {
                    ...
                    if (certificateNode.length !== 0) {
                        ...
                        var x509Certificate = utility_1.default.normalizeCerString(x509CertificateData);
                        selectedCert_1 = x509Certificate;
                    }
                    if (selectedCert_1 === null) {
                        throw new Error('NO_SELECTED_CERTIFICATE');
                    }
                    if (metadataCert.length >= 1 && !metadataCert.find(function (cert) { return cert.trim() === selectedCert_1.trim(); })) {
